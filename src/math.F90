...
!===============================================================================
  ...
  elemental function calc_pn(n,x) result(pnx)
    ...
    case(11)
      pnx = -2.70703125_8 * (x ** 1) + 58.65234375_8 * (x ** 3) &
      -351.9140625_8 * (x ** 5) + 854.6484375_8 * (x ** 7) - 902.1289062_8 * &
      (x ** 9) + 344.4492188_8 * (x ** 11)
    case(12)
      pnx = 0.2255859375_8 - 17.59570312_8 * (x ** 2) + 219.9462891_8 * &
      (x ** 4) - 997.0898438_8 * (x ** 6) + 2029.790039_8 * (x ** 8) &
      -1894.470703_8 * (x ** 10) + 660.1943359_8 * (x ** 12)
    case(13)
      pnx = 2.932617188_8 * (x ** 1) - 87.97851562_8 * (x ** 3) + &
      747.8173828_8 * (x ** 5) - 2706.386719_8 * (x ** 7) + 4736.176758_8 * &
      (x ** 9) - 3961.166016_8 * (x ** 11) + 1269.604492_8 * (x ** 13)
    case(14)
      pnx = -0.2094726562_8 + 21.99462891_8 * (x ** 2) - 373.9086914_8 * &
      (x ** 4) + 2368.088379_8 * (x ** 6) - 7104.265137_8 * (x ** 8) + &
      10893.20654_8 * (x ** 10) - 8252.429199_8 * (x ** 12) + 2448.522949_8 * &
      (x ** 14)
    case(15)
      pnx = -3.142089844_8 * (x ** 1) + 124.6362305_8 * (x ** 3) &
      -1420.853027_8 * (x ** 5) + 7104.265137_8 * (x ** 7) - 18155.34424_8 * &
      (x ** 9) + 24757.2876_8 * (x ** 11) - 17139.66064_8 * (x ** 13) + &
      4733.811035_8 * (x ** 15)
    case(16)
      pnx = 0.1963806152_8 - 26.70776367_8 * (x ** 2) + 592.0220947_8 * &
      (x ** 4) - 4972.985596_8 * (x ** 6) + 20424.76227_8 * (x ** 8) &
      -45388.3606_8 * (x ** 10) + 55703.89709_8 * (x ** 12) - 35503.58276_8 * &
      (x ** 14) + 9171.758881_8 * (x ** 16)
    case(17)
      pnx = 3.338470459_8 * (x ** 1) - 169.1491699_8 * (x ** 3) + &
      2486.492798_8 * (x ** 5) - 16339.80981_8 * (x ** 7) + 56735.45074_8 * &
      (x ** 9) - 111407.7942_8 * (x ** 11) + 124262.5397_8 * (x ** 13) &
      -73374.07104_8 * (x ** 15) + 17804.00253_8 * (x ** 17)
    case(18)
      pnx = -0.1854705811_8 + 31.71546936_8 * (x ** 2) - 888.0331421_8 * &
      (x ** 4) + 9531.555725_8 * (x ** 6) - 51061.90567_8 * (x ** 8) + &
      153185.717_8 * (x ** 10) - 269235.5026_8 * (x ** 12) + 275152.7664_8 * &
      (x ** 14) - 151334.0215_8 * (x ** 16) + 34618.89381_8 * (x ** 18)
    case(19)
      pnx = -3.52394104_8 * (x ** 1) + 222.0082855_8 * (x ** 3) &
      -4084.952454_8 * (x ** 5) + 34041.27045_8 * (x ** 7) - 153185.717_8 * &
      (x ** 9) + 403853.2539_8 * (x ** 11) - 642023.1216_8 * (x ** 13) + &
      605336.0861_8 * (x ** 15) - 311570.0443_8 * (x ** 17) + 67415.74059_8 * &
      (x ** 19)
    case(20)
      pnx = 0.176197052_8 - 37.00138092_8 * (x ** 2) + 1276.547642_8 * &
      (x ** 4) - 17020.63522_8 * (x ** 6) + 114889.2878_8 * (x ** 8) &
      -444238.5793_8 * (x ** 10) + 1043287.573_8 * (x ** 12) -1513340.215_8 *&
      (x ** 14) + 1324172.688_8 * (x ** 16) - 640449.5356_8 * (x ** 18) + &
      131460.6941_8 * (x ** 20)
    case default
