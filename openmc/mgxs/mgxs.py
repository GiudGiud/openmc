...
class TransportXS(MGXS):
    ...
    def xs_tally(self):
        if self._xs_tally is None:
            ...
            if (self.energy_groups.num_groups not in [1, 2, 8, 16, 23, 24, 25, 70, 361]  or (self._domain.id not in [15, 16, 18] or "Fuel" in self._domain.name)):
                ...
                print("Manual transport correction for water transport XS", self._domain.id, self._domain.name)
            ...
            if self.formulation == 'simple':
                if self.scatter_format == 'legendre':
                    ...
                    if self.correction == 'P0' and self.legendre_order == 0:
                        ...
                        if (self.energy_groups.num_groups not in [1, 2, 8, 16, 23, 24, 25, 70, 361]  or self._domain.id not in [15, 18, 19, 20, 21]):
        ...
        if self._xs_tally is None:
            ...
            if self.formulation == 'simple':
                ...
                if self.correction == 'P0' and self.legendre_order == 0:
                    ...
                    if False and (self.energy_groups.num_groups not in [1, 2, 8, 16, 23, 24, 25, 70, 361]  or (self._domain.id not in [15, 16, 18] or "Fuel" in self._domain.name)):
                        self._xs_tally -= correction
                    else:
                        np.set_printoptions(threshold=np.inf)
                        print("Manual tc on scattering matrices in water", self._domain.id, self._domain.name)
